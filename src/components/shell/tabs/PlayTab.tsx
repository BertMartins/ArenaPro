...
export default function PlayTab() {
  ...
  function teamIdx(teamId: string) {
    ...
    return (
      <div className="pb-24 p-4 max-w-2xl mx-auto">
        <div className="glass-card rounded-xl p-6 sm:p-8 text-center mt-8">
          ...
          <button onClick={() => nav.setTab("home")} className="btn-primary px-5 py-2.5 rounded-lg text-white font-bold text-sm">
            Ir para Jogos
          </button>
        </div>
      </div>
  ...
  return (
    <div className="pb-24 animate-fadeIn max-w-2xl mx-auto">
      ...
      <div className="p-3 sm:p-5 space-y-4">
              ...
              <div className="text-center">
                ...
                {isAdmin && !activeMatch.finished && (
                  <div className="flex gap-2 justify-center">
                    <button onClick={() => updateScore(1, -1)} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-red-500 hover:bg-red-400 text-white font-bold text-lg sm:text-xl">−</button>
                    <button onClick={() => updateScore(1, 1)} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-green-500 hover:bg-green-400 text-white font-bold text-lg sm:text-xl">+</button>
                  </div>
                )}
              </div>
              <div className="text-center">
                ...
                {isAdmin && !activeMatch.finished && (
                  <div className="flex gap-2 justify-center">
                    <button onClick={() => updateScore(2, -1)} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-red-500 hover:bg-red-400 text-white font-bold text-lg sm:text-xl">−</button>
                    <button onClick={() => updateScore(2, 1)} className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-green-500 hover:bg-green-400 text-white font-bold text-lg sm:text-xl">+</button>
                  </div>
                )}
              </div>
            </div>
        ...
        {teams.map((team, idx) => (
          <div key={team.id} className="glass-card rounded-xl overflow-hidden" style={{ animationDelay: `${idx * 0.1}s` }}>
        ...
        {isAdmin && (
          <div className="space-y-3">
            ...
            <button onClick={handleFinishGame} disabled={saving}
